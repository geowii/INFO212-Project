...
class ContentGenerator {
    ...
    static #mainTemplate = new ContentTemplate(new TextFileYes("<div class=\"videoMain\"id=\"\n###CONTENT: ID\n\"><video class=\"videoSub\" autoplay loop muted><source src=\"\n###CONTENT: SOURCE\n\" type=\"video/mp4\"></video><div class=\"info\"><p class=\"viewCount\">\n###CONTENT: VIEWS\n</p><p class=\"reaction\">\n###CONTENT: EMOJIS\n</p><p class=\"description\">\n###CONTENT: DESCRIPTION_SHORT\n</p></div><div class=\"commentSection\"><div class=\"userComments\">\n###CONTENT: COMMENT_SHORT\n</div></div><!-- Comment Side Panel --><div class=\"commentPanelWrapper\"><button class=\"commentPanelToggle\" type=\"button\"><span class=\"commentPanelIconOpen\">←</span><span class=\"commentPanelIconClose\">→</span></button> <div class=\"commentPanel\"><h3>Comments</h3><div>\n###CONTENT: COMMENT_SHORT\n</div></div></div></div>"));
