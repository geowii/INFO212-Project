...
post0 = new DataContentMain(account0, "media/clips/counter_strike_2_1.mp4", "200k", "🍆🍑💚", "title", "description");
post0.addComment(new DataComment(account0, "", "so hot omg"));
algo.add(post0);

post1 = new DataContentMain(account1, "media/clips/fortnite_1.mp4", "40k", "🍆🍑💚", "title", "description");
post1.addComment(new DataComment(account1, "", "epic"));
algo.add(post1);

post2 = new DataContentMain(account0, "media/clips/counter_strike_2_3.mp4", "237", "🍆🍑💚", "title", "description");
post2.addComment(new DataComment(account0, "", "yo too sick ngl"));
algo.add(post2);

post3 = new DataContentMain(account0, "media/clips/counter_strike_2_7.mp4", "521M", "🍆🍑💚", "title", "description");
